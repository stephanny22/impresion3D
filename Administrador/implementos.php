        ...
        <div class="containersupp"></div>
            <div class="container" >
                <div class="card">
                    ...
                    <div class="card-body">
                        <form name="formu" action="insertar_implemento.php" method="post">
                            <div class="row">
                            <!-- <div class="col-md-6">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="text" name="description" class="form-control" placeholder="DIGITE LA DESCRIPCION" required="">
                                </div>
                                <div class="col-md-6">
                                    <label for="con">CANTIDAD</label>
                                    <input type="text" name="amount" class="form-control" placeholder="DIGITE LA CANTIDAD" required="">
                                </div>
                                <div class="col-md-12">
                                    <br>
                                    <input type="submit" class="btn btn-primary" value="REGISTRAR IMPLEMENTO">
                                </div>
                            </div>
                        </form>
                    </div> 
                        ...
                        <table id="usu" class="table table-bordered table-striped">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td align='center'>
                                    <button class='btn btn-warning' onclick=window.location="form_modificar_implemento.php?id=<?php echo $implemento['id'];?>">
                                    <span class="material-symbols-outlined">edit_square</span>
                                    <button class='btn btn-primary' onclick=window.location="eliminar_implemento.php?id=<?php echo $implemento['id'];?>">
