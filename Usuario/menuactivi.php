    ...
    <div>
        ...
        <div class="card">
            <div class="card-header bg-info">
                <h3 class="text-white text-center">ACTIVIDADES</h3>
            </div>
            <div class="card-body">
                Link de formulario de actividad 1:
                <br>
                <a href="https://forms.gle/1cAPauxu2fGtKcSN7" target="_blank">Abrir en nueva pestaña</a>
                <br>
                Link de formulario de actividad 2:
                <br>
                <a href="https://forms.gle/5F615x2rFpGEM579A" target="_blank">Abrir en nueva pestaña</a>
                <br>
                Link de formulario de actividad 3:
                <br>
                <a href="https://forms.gle/ozNwP7kii2yV2g5x5" target="_blank">Abrir en nueva pestaña</a>
                <br>
            </div>
        </div>
    </div>
